...
xt = arima.arma_generate_sample(φ, δ, n)
yt = arima.arma_generate_sample(φ, δ, n)
...
title = f"Brownian Motion Series Comparison, n={n}"
plot_name = "cointegration_{n}_sum_comparison_1"
